...
{
    public class OmrMasterRepository
    {
        private readonly DatabaseContext _dbContext;

        public OmrMasterRepository(DatabaseContext dbContext)
        {
        ...
        public async Task<IActionResult> OMR(OmrMasterDto model)
        {
            using (var connection = _dbContext.CreateConnection())
            {
                ...
                try
                {
                    ...
                    var queryResult = await connection.QueryMultipleAsync("Proc_OMRMaster", parameter, commandType: CommandType.StoredProcedure);
        ...
        public DynamicParameters SetCandidate(OmrMasterDto user)
        {
            DynamicParameters parameters = new DynamicParameters();
            parameters.Add("@OperationType", user.BaseModel.OperationType, DbType.String);
            parameters.Add("@OmrId", user.Id, DbType.String);

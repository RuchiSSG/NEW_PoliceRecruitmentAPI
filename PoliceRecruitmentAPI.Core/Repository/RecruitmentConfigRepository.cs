...
{
	public class RecruitmentConfigRepository
	{
		private readonly DatabaseContext _dbContext;

		public RecruitmentConfigRepository(DatabaseContext dbContext)
		{
		...
		public async Task<IActionResult> Get(RecruitmentConfigDto model)
		{
			using (var connection = _dbContext.CreateConnection())
			{
				...
				try
				{
					...
					var queryResult = await connection.QueryMultipleAsync("proc_RecruitConfig", parameter, commandType: CommandType.StoredProcedure);
		...
		public DynamicParameters SetRecruitment(RecruitmentConfigDto user)
		{

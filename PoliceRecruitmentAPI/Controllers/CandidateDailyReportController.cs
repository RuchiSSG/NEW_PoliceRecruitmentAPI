    ...
    namespace PoliceRecruitmentAPI.Controllers
{
    ...
    public class CandidateDailyReportController : ControllerBase
    {
        ...
        [HttpGet("GetHeightChestDataAll")]
        public async Task<IActionResult> GetHeightChestDataAll([FromQuery] CandidateDailyReportDto model)
        {
            try
            {
                ...
                model.BaseModel.OperationType = "GetHeightChestdata";

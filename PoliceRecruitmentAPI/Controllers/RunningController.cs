...
namespace PoliceRecruitmentAPI.Controllers
{
	...
	public class RunningController : ControllerBase
	{
        ...
        [HttpGet("GetAllAppealData")]
        public async Task<IActionResult> GetAllAppealData([FromQuery] RunningDto model)
        {
            try
            {
                ...
                model.BaseModel.OperationType = "GetAllAppealData";
        ...
        [HttpPost("InsertAppeal")]
        public async Task<IActionResult> InsertAppeal([FromBody] RunningDto user)
        {
            try
            {
                if (user.BaseModel == null)
                ...
                user.BaseModel.OperationType = "InsertAppeal";
                var result = await _candidateService.Running(user);
                return result;
            }
            catch (Exception ex)
